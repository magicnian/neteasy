...
class CrackSlider():
    ...
    def __init__(self):
        ...
        # 实际地址
        self.url = 'https://id.163yun.com/register'
    ...
    def crack_slider(self):
        self.open()
        time.sleep(1)
        # phone_input = self.wait.until(self.driver.find_element_by_css_selector('#bg > div:nth-child(2) > div > div > div > div > form > div.m-tab > div.m-tab-content > div:nth-child(1) > div > input'))
        phone_input = self.driver.find_element_by_css_selector('#bg > div:nth-child(2) > div > div > div > div > form > div.m-tab > div.m-tab-content > div:nth-child(1) > div > input')
        phone_input.send_keys('18851631386')
        target = 'target.jpg'
